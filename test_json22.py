...
if idx_dup != -1:
    ...
    # We want to remove from idx_dup up to but not including idx_end (so idx_end is kept)
    c_fixed = c[:idx_dup] + c[idx_end:]
    
    # Let's fix the end of the JSON string
    # The end of origin/main has:
    #     }
    #   ]
    # }
    # {% endschema %}
    # wait, earlier I said it had TWO padding_bottoms!
    # Yes, because the duplicate had padding_bottom and the original had padding_bottom?
    # No, the duplicate chunk is the START of the schema.
        ...
        <span>
          <svg class="icon icon-hamburger" aria-hidden="true" focusable="false" role="presentation" viewBox="0 0 18 16">
            <path d="M1 .5a.5.5 0 100 1h15.71a.5.5 0 000-1H1zM.5 8a.5.5 0 01.5-.5h15.71a.5.5 0 010 1H1A.5.5 0 01.5 8zm0 7a.5.5 0 01.5-.5h15.71a.5.5 0 010 1H1a.5.5 0 01-.5-.5z" fill="currentColor">
                ...
                c_final = c_final.replace("{% schema %}", '\n' + html + '\n<script>\n' + js + '\n</script>\n{% schema %}')
